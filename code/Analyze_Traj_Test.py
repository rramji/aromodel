    ...
    def Compute_CG_Dihedrals(self):
        ...
        for Mol_Bond in self.CG_Bond_List:
            for i in range(len(Mol_Bond)-2):
                ...
                N1[0] = Node1.Bond_Vector[1]*Main.Bond_Vector[2] -  Node1.Bond_Vector[2]*Main.Bond_Vector[1]
                N1[1] = Node1.Bond_Vector[2]*Main.Bond_Vector[0] -  Node1.Bond_Vector[0]*Main.Bond_Vector[2]
                N1[2] = Node1.Bond_Vector[0]*Main.Bond_Vector[1] -  Node1.Bond_Vector[1]*Main.Bond_Vector[0]
         
                N2[0] = Main.Bond_Vector[1]*Node2.Bond_Vector[2] -  Main.Bond_Vector[2]*Node2.Bond_Vector[1]
                N2[1] = Main.Bond_Vector[2]*Node2.Bond_Vector[0] -  Main.Bond_Vector[0]*Node2.Bond_Vector[2]
                N2[2] = Main.Bond_Vector[0]*Node2.Bond_Vector[1] -  Main.Bond_Vector[1]*Node2.Bond_Vector[0]
                
                M1[0] = N1[1]*Main.Bond_Vector[2] - N1[2]*Main.Bond_Vector[1]
                M1[1] = N1[2]*Main.Bond_Vector[0] - N1[0]*Main.Bond_Vector[2]
                M1[2] = N1[0]*Main.Bond_Vector[1] - N1[1]*Main.Bond_Vector[0]
                ...
                if Node1.Bond_Main.CG_Type == "D":
                    Dihedral_List_DADA.append(angle)
                if Node1.Bond_Main.CG_Type == "A":
