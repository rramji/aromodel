...
class Dihedral(object):
    ...
    Instance Variables
        Type = int
        dihedral_2 = Atom object  # was master1
        dihedral_3 = Atom object  # was master2
        dihedral_1 = Atom object  # was slave1
        dihedral_4= Atom object   # was slave2
        dihedral_eq = float
        Coeffs = [list]
    ...
    def __init__(self, dihedral_2, dihedral_3, dihedral_1, dihedral_4, dihedral_eq):
        self.dihedral_2 = dihedral_2 # Atom object
        self.dihedral_3 = dihedral_3 # Atom object
        self.dihedral_1 = dihedral_1
        self.dihedral_4 = dihedral_4
    ...
    def Compare_dihedrals(self,atom_1,atom_2,atom_3,atom_4):
        if (self.dihedral_1 == atom_1 and self.dihedral_2 == atom_2 and self.dihedral_3 == atom_3 and self.dihedral_4 == atom_4) or (self.dihedral_1 == atom_4 and self.dihedral_2 == atom_3 and self.dihedral_3 == atom_2 and self.dihedral_4 == atom_1):
            return True
        else:
            return False
