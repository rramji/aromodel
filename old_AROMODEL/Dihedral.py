...
class Dihedral(object):
    ...
    def Compare_Dihedrals(self,slave1,master1,master2,slave2):
        if (self.Dihedral_Slave1 == slave1 and self.Dihedral_Master1 == master1 and self.Dihedral_Master2 == master2 and self.Dihedral_Slave2 == slave2) or (self.Dihedral_Slave1 == slave2 and self.Dihedral_Master1 == master2 and self.Dihedral_Master2 == master1 and self.Dihedral_Slave2 == slave1):
            return True
        else:
            return False
